...
description: >
  Design security awareness programs — training curriculum, phishing simulations, metrics, role-based content, and compliance.
  TRIGGER when: user says /security-awareness or asks about security training programs.
