...
name: cloud-security
description: >
  Review cloud security posture — IAM, network controls, encryption, logging, compliance, and misconfiguration detection.
  TRIGGER when: user says /cloud-security or asks about cloud security assessment.
