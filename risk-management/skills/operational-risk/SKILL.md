...
description: >
  Manage operational risks — process failure analysis, people risks, system risks, external events, KRIs, and loss event tracking.
  TRIGGER when: user says /operational-risk or asks about operational risk management.
