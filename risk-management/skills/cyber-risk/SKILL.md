...
name: cyber-risk
description: >
  Assess cyber risks — threat landscape, vulnerability assessment, asset criticality, attack scenarios, quantitative risk estimation (FAIR), and mitigation.
  TRIGGER when: user says /cyber-risk or asks about cybersecurity risk assessment.
