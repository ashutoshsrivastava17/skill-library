...
description: >
  Assess third-party risks — vendor criticality tiering, due diligence, ongoing monitoring, contract safeguards, and exit planning.
  TRIGGER when: user says /third-party-risk or asks about vendor risk assessment.
