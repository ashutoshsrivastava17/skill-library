...
name: fraud-risk
description: >
  Assess fraud risks — fraud triangle analysis, control mapping, red flag indicators, detection mechanisms, and prevention strategies.
  TRIGGER when: user says /fraud-risk or asks about fraud risk assessment.
