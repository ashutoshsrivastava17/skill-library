...
description: >
  Build sales enablement — content library, playbooks, training curriculum, tool stack, and effectiveness measurement.
  TRIGGER when: user says /sales-enablement or asks about sales training and enablement.
