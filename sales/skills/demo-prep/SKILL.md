...
name: demo-prep
description: >
  Prepare product demos — audience research, demo flow, feature-to-pain mapping, objection preparation, and follow-up strategy.
  TRIGGER when: user says /demo-prep or asks about demo preparation.
