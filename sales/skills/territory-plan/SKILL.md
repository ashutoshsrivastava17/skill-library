...
name: territory-plan
description: >
  Plan sales territories — market segmentation, account distribution, quota setting, coverage models, and performance benchmarks.
  TRIGGER when: user says /territory-plan or asks about sales territory design.
