...
description: >
  Develop pricing strategies — value-based pricing, competitive analysis, packaging/tiering, discounting frameworks, and price testing.
  TRIGGER when: user says /pricing-strategy or asks about product pricing.
